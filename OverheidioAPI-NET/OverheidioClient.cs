...
namespace OverheidioApi.NET
{
    public class OverheidioClient
    {
        ...
        /// <summary>
        /// Find corporations by specifying searchcriteria
        /// </summary>
        /// <param name="size">How many results shoud be returned, default 100</param>
        ...
        /// <param name="fields">Fields to be included in the result. By default tradename, dossier- and subdossiernumber are included. See following link for all possible field <see href="https://overheid.io/documentatie/kvk#show"/></param>
        /// <param name="filters">Used for specifying filters. Key is the field, value is the value to filter on. I.e. key: postcode, value: 3083cz. See following link for all possible field <see href="https://overheid.io/documentatie/kvk#show"/></param>
        /// <returns>List of results found including JSON+HAL metadata</returns>
        public async Task<OverheidioResponse> Find(int size = 100, int page = 1, string order = "desc", string sort = "", string query = "",
